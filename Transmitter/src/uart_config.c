...
enum error_type init_uart(const struct uart_init* init_struct, uint32_t uart_freq)
{
...
{
	/* UDRE1 is set to indicate that the transmitter is ready 
	   Wait until transmitter isn't ready - while UDRE1 == 0 
	*/ 
